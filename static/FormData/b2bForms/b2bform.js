...
export const b2bForm = [
	...
	[
		{
			id: "service_price_category",
			label: "Service's Price Category",
			placeholder: "",
			type: "select",
			validationType: "string",
			options: { data: budget, dependsOn: "service_category" },
			value: "",
			validations: [
				{
					type: "required",
	...
	],
	{
		...
		label: "Occupation's Service(Others)",
		ElementParams: { variant: "outlined" },
		placeholder: "",
		type: "textarea",
		rows: 4,
	...
	[
		...
		// 	label: "bussineess description",
		// 	placeholder: "",
		// 	type: "text",
		// 	validationType: "string",
		// 	ElementParams: { variant: "outlined" },
		// 	value: "dfdskjghkdfgjd",
		// 	validations: [
		// 		{
		// 			type: "required",
		// 			params: ["Field is required"],
